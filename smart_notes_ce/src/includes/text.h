...
// deleteChar() seeks to a given offset in a variable and deletes 1 byte from that offset by moving all the data past the given offset back 1 byte and resizing the variable to be 1 byte smaller
