...
static void dispHomeScreenBG(void)
{
	...
	// footer
	gfx_SetColor(MEDIUM_GREY);
	gfx_FillRectangle_NoClip(FILE_VIEWER_X + FILE_VIEWER_BORDER_RADIUS, FILE_VIEWER_Y + FILE_VIEWER_HEIGHT - FILE_VIEWER_FOOTER_HEIGHT + 2, FILE_VIEWER_WIDTH - FILE_VIEWER_BORDER_RADIUS * 2, FILE_VIEWER_BORDER_RADIUS);
